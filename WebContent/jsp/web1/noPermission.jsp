...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
   <tr>
       <td width="17" valign="top" background="${ctx}/images/mail_leftbg.gif">
    ...
    <td width="16" valign="top" background="${ctx}/images/mail_rightbg.gif">
    ...
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <!-- 树形菜单开始 -->
            <%--  <%@ include file="/jsp/tree/SimpleTree.jsp"%> --%>
             <table width="100%" height="524" border="0" cellpadding="0" cellspacing="0" class="line_table">
	          <tr>
	            <td width="7%" height="27" background="${ctx}/images/news-title-bg.gif">
	             
	            </td>
	            <td width="93%" background="${ctx}/images/news-title-bg.gif" class="left_bt2">用户信息</td>
	          </tr>
	          <tr>
	            <td colspan="2">	
	            	<iframe border="1" id="iframepage" src="${ctx}/jsp/tree/SimpleTree.jsp" height="100%"  min-height:484px; frameborder="0" onLoad="iFrameHeight()" ></iframe>
                 </td>
	          </tr>
	        </table>
        <!-- 树形菜单结束 -->              
        ...
        <td colspan="3" valign="top">
          ...
          <tr>
            <td width="7%" height="27" background="${ctx}/images/news-title-bg.gif">
            <img src="${ctx}/images/news-title-bg.gif" width="2" height="27">
            </td>
            <td width="93%" background="${ctx}/images/news-title-bg.gif" class="left_bt2">最新动态</td>
          </tr>
          <tr>
      ...
      <tr>
        <td width="2%">&nbsp;</td>
        <td width="51%" class="left_txt"><img src="${ctx}/images/icon-mail2.gif" width="16" height="11"> 客户服务邮箱：215288671@qq.com<br>
              <img src="${ctx}/images/icon-phone.gif" width="17" height="14"> 官方网站：http://www.mycodes.net</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table>
  ...
  <tr>
    ...
    <td background="${ctx}/images/buttom_bgs.gif"></td>
